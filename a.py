...
def start_screen():
    fon = pygame.transform.scale(load_image('fon.jpg', True), (1000, 1000))
    screen.blit(fon, (0, 0))
    while True:
...
tile_images = {'wall': load_image('box.png'), 'empty': load_image('floor.png'),
               'axe_of_bloodlust': load_image('axe_of_bloodlust.png'),
...
heal_pc = 0
camera = Camera()
# РёР·РјРµРЅСЏРµРј СЂР°РєСѓСЂСЃ РєР°РјРµСЂС‹
camera.update(player)
# РѕР±РЅРѕРІР»СЏРµРј РїРѕР»РѕР¶РµРЅРёРµ РІСЃРµС… СЃРїСЂР°Р№С‚РѕРІ
